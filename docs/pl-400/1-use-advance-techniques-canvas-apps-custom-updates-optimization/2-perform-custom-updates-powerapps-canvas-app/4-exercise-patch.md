...
13. Align your controls like the image below:
    ...
    ![Screenshot of Patch Exercise controls after alignment.](media/aligned-controls.png)
14. Before we move on, notice that the formula bar has a **Copilot** icon on the left side. If you're relatively new to Power Apps, or you're trying to figure out what the code in a formula means, you can select the Copilot icon and ask it to "Explain this formula." When you do, you should see something similar to the image below.

    ![Screenshot of Copilot comments.](media/copilot-comments.png)

    The explanation has a **Copy** button where you can copy the text of this answer and then add it to your code as a remark. Add the double forward "//" slashes to add comments to your code like this:
    ...
    ```
15. Now let's add more Countries/Regions to our Gallery. Put the app in **Preview** mode.
16. In the **Country** text input, enter USA. In the **City** text input, enter Orlando. In the **Population** text input, enter 280832.
17. Now press your **Patch Country** button and scroll down to the bottom of your gallery; you should see the new record you just added by using the **Patch** function formula from the OnSelect property of the button.
