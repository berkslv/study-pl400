...
5. Set the **OnStart** property to this formula that we're using to create a collection of customer numbers and the associated invoice numbers (just copy and paste it into the fx formula bar):
    ...
    ```
6. Select the **ellipsis (ÔÇĞ)** next to the App object and select **Run OnStart**. This runs the **OnStart** formula you just entered and populates your collection **colCustomer**.
...
[![Screenshot of the gallery with the trash can icons displayed.](media/6a-exercise-gallery-trashcan.png)](media/6a-exercise-gallery-trashcan.png#lightbox)
...
17. Set the lbl\_popup **Text** to the below formula:

    ```powerappsfl
    varUserDisplayName & "
    Please click Delete to confirm deletion of Invoice#" & " " & Gallery1.Selected.InvoiceNumber
    ```
18. Select **Insert** &gt; **Button** and name your new button: button\_Delete; set its **Text** property to: Delete
19. Set the Delete **Button** **OnSelect** property to the below:
    ...
    ```
20. Select **Insert** &gt; **Button** and name the new button: button\_Cancel; set its **Text** property to: Cancel
