...
To learn about creating canvas apps, see the [Create a canvas app in Power Apps](/en-us/training/paths/create-powerapps/?azure-portal=true) learning path. For a high-level introduction on creating model-driven apps, see the [Create a model-driven application in Power Apps](/en-us/training/paths/create-app-models-business-processes/?azure-portal=true) learning path.
...
To learn more about building cloud flows with Power Automate, see the [Automate a business process using Power Automate](/en-us/training/paths/automate-process-using-flow/?azure-portal=true) learning path. For an introduction to desktop flows, see the [Get started with Power Automate for desktop](/en-us/training/paths/pad-get-started/?azure-portal=true) learning path.
...
For an introduction on how to create Power BI reports, see the [Create and use analytics reports with Power BI](/en-us/training/paths/create-use-analytics-reports-power-bi/?azure-portal=true) learning path.
...
To learn more about building websites with Power Pages, see the [Get Started with Power Pages](/en-us/training/paths/power-pages-get-started/?azure-portal=true) learning path.
...
For an introduction on how to create copilots using Copilot Studio, see the [Create copilots with Copilot Studio learning path](/en-us/training/paths/work-power-virtual-agents/?azure-portal=true).
...
You can learn more about custom connectors in the [connectors documentation](/en-us/connectors/?azure-portal=true) or from the [Get started with Power Automate for desktop](/en-us/training/paths/build-custom-connectors/?azure-portal=true) learning path.
...
For a more in-depth look at Common Data Service, see the [Get started with Dataverse](/en-us/training/modules/get-started-with-powerapps-common-data-service/?azure-portal=true) module.
...
To learn more about how to use the Common Data Model, see the [Common Data Model documentation](/en-us/common-data-model/schema/core/applicationCommon/overview/?azure-portal=true).
