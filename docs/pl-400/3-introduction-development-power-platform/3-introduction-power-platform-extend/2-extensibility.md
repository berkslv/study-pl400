...
You can follow the [complete walkthrough](/en-us/power-apps/developer/model-driven-apps/clientapi/walkthrough-write-your-first-client-script/?azure-portal=true) of this example for specifics on how it hooks up to the form.
