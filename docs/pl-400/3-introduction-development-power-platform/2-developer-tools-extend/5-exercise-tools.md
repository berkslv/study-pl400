...
Use a test environment with Microsoft Dataverse provisioned. If you don't have one you can sign up for the [Developer Plan](https://www.microsoft.com/power-platform/products/power-apps/?azure-portal=true).
...
6. You'll see a list of system plug-ins. If you do this on an environment with custom plug-ins you would see them in the list as well. The (Assembly) are .NET DLLs that implement the plug-ins.
