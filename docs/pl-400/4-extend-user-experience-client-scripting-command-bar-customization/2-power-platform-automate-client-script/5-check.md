...
1.
When would you use the Client API Xrm.WebAPI object?
...
2.
What does Solution Checker allow you to do?
...
3.
When would you use client script instead of business rules in a model-driven app?
