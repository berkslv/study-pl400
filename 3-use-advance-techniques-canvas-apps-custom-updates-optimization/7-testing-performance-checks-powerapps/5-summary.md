...
- [Power Apps Monitor overview](https://learn.microsoft.com/en-us/power-apps/maker/monitor-overview/)
- [Concurrent function reference](https://learn.microsoft.com/en-us/power-platform/power-fx/reference/function-concurrent/)
- [Create performant apps overview](https://learn.microsoft.com/en-us/power-apps/maker/canvas-apps/create-performant-apps-overview/)
